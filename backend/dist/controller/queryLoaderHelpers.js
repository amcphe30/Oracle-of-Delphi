...
const unzip = (content) => __awaiter(void 0, void 0, void 0, function* () {
    const unzippedFiles = [];
    const jsZip = new jszip_1.default();
    let tryResult;
    try {
    ...
    const fileProms = Object.keys(result.files).map((filename) => __awaiter(void 0, void 0, void 0, function* () {
        const fileData = yield result.files[filename].async("string");
        unzippedFiles.push(fileData);
    }));
    yield Promise.all(fileProms);
